...
const card = await zelt.cards.issue({
  ...
  funding: {
    currency: "USDC",
    chain: "ethereum",
    spend_limit: 5000_00, // $5,000 in cents
  },
  type: "virtual",
});
...
export default function ApiSection() {
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse 50% 40% at 50% 50%, rgba(37,99,235,0.07) 0%, transparent 70%)",
      }}
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Built for builders,{" "}
              <span className="gradient-text">not bankers</span>
            </h2>
            <p className="text-lg mb-10" style={{ color: "rgba(255,255,255,0.45)" }}>
              REST API and SDKs that feel like fintech — not legacy financial
              middleware. Ship your card program with a few hundred lines of
              code.
            </p>
